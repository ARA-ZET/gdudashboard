        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-10 lg:grid-cols-12 lg:gap-12">
          <div className="col-span-2 lg:col-span-4">
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <WhatsAppLink aria-label="WhatsApp" className="grid h-10 w-10 place-items-center rounded-md border border-white/15 hover:border-gold hover:text-gold transition-colors"><Icon name="whatsapp" className="h-4 w-4" /></WhatsAppLink>
            </div>
          </div>
