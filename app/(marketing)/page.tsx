...
import { services, faqs, projects, hasTestimonials } from '@/lib/content';
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-navy text-white">
        ...
        <div className="container-x relative grid items-center gap-10 py-12 md:py-16 lg:grid-cols-2 lg:gap-12 lg:py-24">
          <Reveal>
            <Eyebrow light>Upholstery &amp; reupholstery specialists</Eyebrow>
            <h1 className="mt-5 text-display !text-white">
              Reupholstery &amp; repairs in <span className="text-gold">Cape Town</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              ...
              <WhatsAppButton />
              <Link href="/portfolio" className="btn btn-outline-light"><span className="sm:hidden">Our Work</span><span className="hidden sm:inline">View Our Work</span></Link>
            </div>
          ...
          {/* The photo shows at every width — most visitors are on a phone. Only
              the overlapping cards are desktop-only: they need the gutter space
              outside the image, which does not exist at container width. */}
          <Reveal delay={120} className="relative">
            <div className="relative overflow-hidden rounded-xl shadow-ambient-lg ring-1 ring-white/10">
              <Photo photo={photos.heroSofa} priority className="aspect-[16/10] w-full lg:aspect-[4/3]" />
            </div>
            <div className="absolute -bottom-6 -left-6 hidden w-44 rounded-lg bg-surface-white p-5 text-navy shadow-ambient-lg lg:block">
            ...
            <div className="absolute -right-4 top-8 hidden items-center gap-2 rounded-lg bg-gold px-4 py-3 text-navy shadow-ambient-lg lg:flex">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <Reveal className="relative order-2 lg:order-1">
              <div className="overflow-hidden rounded-xl ring-1 ring-white/10">
                <Photo photo={photos.armchairDetail} variant="rust" className="aspect-[5/4] w-full" />
              </div>
        ...
        <div className="container-x">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {projects.slice(0, 3).map((p, i) => (
              <Reveal key={p.slug} delay={i * 90} className="card group overflow-hidden">
                <div className="relative">
                  <Photo photo={p.image} variant={p.swatch} className="aspect-[4/3] w-full" />
                ...
                <div className="p-6">
                  ...
                  <p className="mt-2 text-[14px] leading-relaxed text-ink-muted">{p.summary}</p>
                </div>
              </Reveal>
            ))}
          </div>
