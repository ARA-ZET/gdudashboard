    ...
    <div className="grid min-h-screen place-items-center bg-navy p-5 texture-tufted">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <p className="mt-4 text-[11px] font-semibold uppercase tracking-[0.22em] text-gold-400">Admin</p>
          <p className="mt-1 text-[13px] text-white/60">Sign in to manage quotes & invoices</p>
        </div>
